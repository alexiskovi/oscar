 ...
 */
class PIDSteerController {
 public:
  /**
   * @brief initialize pid controller
   * @param pid_conf configuration for pid controller
   */
  void Init(const PidSteerConf &pid_steer_conf);
   ...
   * @param pid_conf configuration for pid controller
   */
  void SetPID(const PidSteerConf &pid_steer_conf);
   ...
   */
  virtual double Control(const double angle, const double goal, const double dt);
