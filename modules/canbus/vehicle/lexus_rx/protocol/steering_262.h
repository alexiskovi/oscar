 ...
 */
class Steering262 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  virtual void Parse(const std::uint8_t *bytes, int32_t length,
   ...
   private:
       ...
       uint8_t ipas_state(const std::uint8_t *bytes, int32_t length) const;
       uint8_t lka_type( const std::uint8_t *bytes, int32_t length) const;
